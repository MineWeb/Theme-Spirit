                    ...
                    <div class="col-md-12 well setup-content text-center">
                        ...
                        <form data-ajax="true" action="<?= $this->Html->url(['action' => 'setUser']) ?>" method="post" data-callback-function="afterSetUser">
                            <div style="width: 350px;display: inline-block;">
                                ...
                                <input type="text" class="form-control" name="username" placeholder="Kr0ZiX" <?= ($user) ? 'value="' . $user['pseudo'] . '" disabled' : '' ?>>
                            </div>
                            <br><br>
                            <button class="btn btn-success" type="submit">Passer a l'étape suivante</button>
                            <a class="btn btn-success" id="display-rewards" data-toggle="modal" data-target="#rewards" style="color:white;"><?= $Lang->get('VOTE__DISPLAY_REWARDS'); ?></a>
                        </form>
